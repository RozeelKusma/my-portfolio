                ...
                {i % 2 === 0 ? (
                  <>
                    ...
                    >
                      ...
                      <h3 className="font-heading font-700 text-xl text-paper mb-1">
                        {exp.role}
                      </h3>
                      <p className="font-heading font-600 text-accent text-base mb-1">
                        {exp.company}
                      </p>
                      <p className="font-mono text-muted text-xs mb-1">
                        {exp.location}
                      </p>
                  ...
                  <>
                    <Reveal
                      delay={i * 80 + 100}
                      direction="left"
                      className="md:pr-12 mb-4 md:mb-0 order-2 md:order-1"
                    >
                      <div className="bg-card border border-border rounded-2xl p-6 space-y-3 hover:border-accent/20 transition-colors">
                        {exp.highlights.map((h, j) => (
                          <div key={j} className="flex gap-3">
                    ...
                    <Reveal
                      delay={i * 80}
                      direction="right"
                      className="md:pl-12 order-1 md:order-2 mb-4 md:mb-0"
                    >
                      <h3 className="font-heading font-700 text-xl text-paper mb-1">
                        {exp.role}
                      </h3>
